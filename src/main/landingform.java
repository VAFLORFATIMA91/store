...
//        setLocationRelativeTo(null); // center landing form
    ...
    private void initComponents() {
        ...
        jLabel4.setFont(new java.awt.Font("Tempus Sans ITC", 2, 120)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 102, 0));
        jLabel4.setText("SHOP");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 100, 330, -1));

        jPanel2.setBackground(new java.awt.Color(0, 204, 204));
        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setBackground(new java.awt.Color(204, 204, 204));
        jLabel2.setFont(new java.awt.Font("Britannic Bold", 1, 100)); // NOI18N
        jLabel2.setText("EASY");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 60, 260, 90));
